...
with open("process_exoplanets.py", "r", encoding="utf-8") as f:
    content = f.read()
...
with open("process_exoplanets.py", "w", encoding="utf-8") as f:
    f.write(content)

print("process_exoplanets.py updated successfully.")
